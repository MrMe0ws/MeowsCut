...
Собранный установщик ставится в профиль пользователя, права администратора не нужны.
Portable-вариант — папка, которую достаточно скопировать: .NET ставить не надо,
FFmpeg лежит рядом с `MeowsCut.exe`.
