...
MP4, MKV, WebM, MOV, AVI; H.264, H.265, VP9, AV1; постоянное качество,
битрейт или подгон под размер файла. Выравнивание громкости по EBU R128. Аппаратное кодирование (NVENC, Quick Sync, AMF),
...
./tools/build-installer.ps1 -Version 0.2.0   # установщик
